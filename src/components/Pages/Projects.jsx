    ...
    <div className="d-flex h-100 align-items-center">
      <div className="container">
        <header className="text-center m-5">
          <h1 className="title text-uppercase lined" style={{fontFamily: 'Rampart One'}}> Projects</h1>
        </header>
        <div class="row justify-content-center pb-5">
          ...
          PROJECT 1
          */}
          <Card inverse className="container expand col-md-6 col-lg-4 m-1">
            ...
            <CardImgOverlay className="middle">
              ...
              <CardText className='text text-center' style={{fontFamily: 'Fredoka One'}}>Provides users a way to get personalized weekly meal plans based on each user’s: daily calorie goal, diet, and any foods to exclude. APIs: The spoonacular API Recipe – Food – Nutrition and Quotes Inspirational Quotes Motivational Quotes API.</CardText>
              {/* <CardText>
          ...
          Work Day Scheduler
          */}
          <Card inverse className="container expand col-md-6 col-lg-4 m-1 box-shadow">
            ...
            <CardImgOverlay className="middle">
              ...
              <CardText className='text text-center'style={{fontFamily: 'Fredoka One'}}>Provides input blocks for each hour of the workday, 9am - 5pm, to allow the users to save notes for work events during specific times.</CardText>
              {/* <CardText>
                <small className="text-muted">Languages Used: HTML5, CSS, JavaScript, Materialize, Foundation, jQuery, moment.js, Markdown</small>
              </CardText> */}
              <div className="text-center">
          ...
          */}
          <Card inverse className="container expand col-md-6 col-lg-4 m-1">
            ...
            <CardImgOverlay className="middle">
              ...
              <CardText className='text text-center'style={{fontFamily: 'Fredoka One'}}>Uses the Open Weather Map APIs and moment.js to provide information about the current and five-day forecast based on the city search input.</CardText>
              {/* <CardText>
                <small className="text-muted">Languages Used: HTML5, CSS, JavaScript, Materialize, Foundation, jQuery, moment.js, Markdown</small>
              </CardText> */}
              <div className="text-center">
